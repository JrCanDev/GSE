...
class Emprunt
{
    ...
    {
        try {
            $fields = array('id_emprunt', 'nom_emprunteur', 'prenom_emprunteur', 'id_groupe', 'nom_groupe', 'date_emprunt', 'date_prevue_restitution', 'date_reelle_restitution', 'caution', 'etat_restitution', 'remarque_restitution');
