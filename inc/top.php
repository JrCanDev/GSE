...
<div class="w3-display-container top_header" style="min-height: 100px; max-height: 200px;">
  ...
  <div class="w3-padding w3-display-topright w3-margin" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
    <?php
    $displayUser = trim(sanitize($_SESSION['user']['username'] ?? 'Invité'));
    ...
    <?php else: ?>
      <a href="login.php" class="w3-button w3-green w3-round">Se connecter</a>
    <?php endif; ?>
  </div>
</div>
...
<script>
  ...
  if (disconnectImg) {
    disconnectImg.addEventListener('click', function() {
